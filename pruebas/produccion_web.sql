...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 24-09-2020 a las 09:38:22
...
--
-- Filtros para la tabla `continentes`
--
ALTER TABLE `continentes`
  ADD CONSTRAINT `continentes_ibfk_1` FOREIGN KEY (`activo`) REFERENCES `productos` (`activo`);
...
ALTER TABLE `paises`
  ...
  ADD CONSTRAINT `paises_ibfk_2` FOREIGN KEY (`activo`) REFERENCES `productos` (`activo`);
