        ...
        <div class="main container-fluid">
            ...
            <form action="campos_dinamicos.php" method="post" class="col-12 from-horizontal">
                <div class="form-group row">
                    <label for="campos_dinamicos-label" class="col-sm-4 control-label">Texto</label>
                    <label for="campos_dinamicos-tipo" class="col-sm-4 control-label">Tipo</label>
                    <label for="campos_dinamicos-tipo" class="col-sm-4 control-label">Valores</label>
...
<!--                     <script>
                    ...
                    <div class="col-sm-4">
                        <select style="width:400px;height:35px" name="tipo" id="tipo" <!-- onchange="enableDisableCodigo()" -->>
